...
namespace Bee.Base
{
    ...
    public class TFtpClient
    {
        ...
        public TFtpClient(string endpoint, string username, string password)
        {
        ...
        public TConnectionTestResult TestConnection()
        {
            ...
            try
            {
                ...
                {
                    return new TConnectionTestResult(true, oResponse.StatusDescription);
                }
            }
            catch (Exception ex)
            {
                return new TConnectionTestResult(false, ex.Message);
            }
        }
        ...
        public List<TFtpItem> ListFiles(string remotePath)
        {
            FtpWebRequest oRequest;
            FtpWebResponse oResponse;
            StreamReader oReader;
            List<TFtpItem> oItems;
            TFtpItem oItem;
            string sLine;

            oItems = new List<TFtpItem>();
        ...
        private TFtpItem ParseFtpItem(string line)
        {
