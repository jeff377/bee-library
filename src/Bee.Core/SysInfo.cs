...
namespace Bee.Core
{
    ...
    public static class SysInfo
    {
        static SysInfo()
        {
            ...
            AllowedTypeNamespaces = new List<string> { "Bee.Core", "Bee.Definition", "Bee.Contracts" };
        }
        ...
        /// Note: Bee.Core and Bee.Definition are built-in default namespaces and do not need to be specified.
        /// </summary>
