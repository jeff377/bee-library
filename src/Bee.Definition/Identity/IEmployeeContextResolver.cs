namespace Bee.Definition.Identity
{
    ...
    /// the common <c>st_user</c> account to its <c>ft_employee</c> record in a company database.
    ...
    public interface IEmployeeContextResolver
    {
        ...
        /// <param name="databaseId">The company database id (where <c>ft_employee</c> lives).</param>
