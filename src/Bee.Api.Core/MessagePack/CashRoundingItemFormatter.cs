...
namespace Bee.Api.Core.MessagePack
{
    ...
    /// <para>
    /// WARNING: Adding a property to <see cref="CashRoundingItem"/> means adding it here too. The guard is the
    /// <see cref="WireMemberCount"/> assertion in the wire tests, which fails as soon as the two
    /// shapes drift apart.
    /// </para>
    /// </remarks>
    internal sealed class CashRoundingItemFormatter : IMessagePackFormatter<CashRoundingItem?>
    {
        /// <summary>
