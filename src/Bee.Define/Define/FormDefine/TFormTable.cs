...
namespace Bee.Define
{
    ...
    [Description("表單資料表。")]
    [TreeNode]
    public class TFormTable : TKeyCollectionItem
    {
        private string _DbTableName = string.Empty;
        private string _DisplayName = string.Empty;
        private TFormFieldCollection _Fields = null;
        ...
        public TFormTable(string tableName, string displayName)
        {
        ...
        [Description("欄位集合。")]
        [DefaultValue(null)]
        public TFormFieldCollection Fields
        {
            get
            {
                // 序列化時，若集合無資料則傳回 null
                if (BaseFunc.IsSerializeEmpty(this.SerializeState, _Fields)) { return null; }
                if (_Fields == null) { _Fields = new TFormFieldCollection(this); }
                return _Fields;
            }
        }
