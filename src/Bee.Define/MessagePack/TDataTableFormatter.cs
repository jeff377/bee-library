...
namespace Bee.Define
{
    ...
    /// </summary>
    public class TDataTableFormatter : IMessagePackFormatter<DataTable>
    {
        /// <summary>
        /// 序列化 DataTable 物件。
        /// </summary>
        ...
        public void Serialize(ref MessagePackWriter writer, DataTable value, MessagePackSerializerOptions options)
        {
            ...
            var sdt = TSerializableDataTable.FromDataTable(value);
        ...
        public DataTable Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
        {
            ...
            var sdt = MessagePackSerializer.Deserialize<TSerializableDataTable>(ref reader, options);
            return TSerializableDataTable.ToDataTable(sdt);
        }
    }
}
