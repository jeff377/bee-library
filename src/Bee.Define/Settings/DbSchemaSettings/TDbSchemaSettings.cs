...
namespace Bee.Define
{
    ...
    [Description("資料庫結構設定。")]
    [TreeNode("資料庫結構")]
    public class TDbSchemaSettings : IObjectSerializeFile
    {
        ...
        private TDbSchemaCollection _Databases = null;
        ...
        [Description("資料庫結構集合。")]
        [DefaultValue(null)]
        public TDbSchemaCollection Databases
        {
            get
            {
                // 序列化時，若集合無資料則傳回 null
                if (BaseFunc.IsSerializeEmpty(this.SerializeState, _Databases)) { return null; }
                if (_Databases == null) { _Databases = new TDbSchemaCollection(this); }
                return _Databases;
            }
        }
    }
