namespace Bee.Business.System
{
    ...
    /// <c>progId</c> through <see cref="Bee.Definition.IBusinessObjectFactory"/>, casts to the axis
    ...
    /// <see cref="Bee.Definition.IBusinessObjectFactory"/> and calls it — another business object, a background job, a
    ...
    /// reads and writes definitions through <see cref="Bee.Definition.Storage.IDefineAccess"/> directly, so routing that through
