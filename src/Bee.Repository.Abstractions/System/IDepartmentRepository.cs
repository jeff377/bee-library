...
{
    /// <summary>
    /// Data access for a company's department table (<c>st_department</c>). Lives in a company
    ...
    {
        /// <summary>
        /// Reads every department row from the company database's <c>st_department</c> table as flat
