...
- **JSON-RPC frontend integration guide** — New [`docs/jsonrpc-frontend-integration.md`](../jsonrpc-frontend-integration.md) (bilingual) covering wire format, headers, auth flow, callable method catalog, `JsonRpcErrorCode` mapping, and a copy-paste TypeScript wrapper. Intended for React / Vue / Angular / vanilla JS consumers.
