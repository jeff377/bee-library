# Bee.NET 4.11.0 — 詳細版本說明

[English](4.11.0.md) ・ [繁體中文](4.11.0.zh-TW.md) ・ [← CHANGELOG](../../CHANGELOG.zh-TW.md)

本檔是 [CHANGELOG.zh-TW.md](../../CHANGELOG.zh-TW.md) 中 `[4.11.0]` 條目的詳細版；主 changelog 每項只列一行重點，本檔保留完整敘事——每項變更的「為什麼」、限制與設計脈絡。
