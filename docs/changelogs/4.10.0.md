...
- **Lookup relation mechanism (`Bee.Definition` / `Bee.Api` / `Bee.UI.Avalonia`)** — a definition-driven dialog lookup (design in [ADR-023](../adr/adr-023-lookup-relation-mechanism.md)):
