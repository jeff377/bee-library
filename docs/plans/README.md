...
| 計畫 | 狀態 | 說明 |
|------|------|------|
| [建立框架壓測設施](plan-load-testing.md) | ✅ 已完成（2026-09-07） | `tools/Bee.LoadTests`（零壓測框架相依，驅動程式自寫）。三階段全數落地：Local 層四場景、Remote 層與 Local 對照、報告三層輸出。取數規範見 `docs/repo-ops/load-testing.md` |
