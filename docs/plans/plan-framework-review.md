...
| P3 | 文件漂移與低風險清理 | — | 🚧 **進行中**（DOC 系列 19 條 ✅、ARCH-2 / ARCH-3 ✅、T-5 ✅、T-7 ✅ + 衍生 T-8 的 A 類 ✅、T-6 部分完成、**CON-5 / SEC-4 / SEC-5 / T-3 ✅**、**S-4~S-10 ✅**、**D-2 / D-3 / M-1 / M-2 / M-3 / T-4 ✅**；**SEC-6 ✅**、**CON-6 ❌ 撤回**；剩 API-3~API-5、D-4） |
