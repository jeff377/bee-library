...
| 2 | bee-ui-winforms | `src/Bee.UI.WinForms` | WinForms UI 元件 ✅ 已移植 |
| 3 | bee-api-aspnet | `src/Bee.Api.AspNet` | .NET Framework 網站服務 ✅ 已移植 |
...
4. **Bee.Api.AspNet** — ✅ 已移植至 [bee-api-aspnet](https://github.com/jeff377/bee-api-aspnet)
5. **Bee.UI.Core** — ✅ 已移植至 [bee-ui-core](https://github.com/jeff377/bee-ui-core)（尚未發布 NuGet，待命名空間調整後打 tag）
6. **Bee.UI.WinForms** — ✅ 已移植至 [bee-ui-winforms](https://github.com/jeff377/bee-ui-winforms)
