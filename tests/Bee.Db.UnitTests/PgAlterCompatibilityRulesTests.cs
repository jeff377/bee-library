...
namespace Bee.Db.UnitTests
{
    ...
    public class PgAlterCompatibilityRulesTests
    {
        ...
        [DisplayName("PG GetKindForTypeChange：同型別應為 Alter")]
        public void GetKindForTypeChange_SameType_ReturnsAlter(FieldDbType from, FieldDbType to)
        {
            Assert.Equal(ChangeExecutionKind.Alter, PgAlterCompatibilityRules.GetKindForTypeChange(from, to));
        }
        ...
        [DisplayName("PG GetKindForTypeChange：同 family 應為 Alter")]
        ...
        [DisplayName("PG GetKindForTypeChange：跨 family 應為 Rebuild")]
        public void GetKindForTypeChange_CrossFamily_ReturnsRebuild(FieldDbType from, FieldDbType to)
        {
            Assert.Equal(ChangeExecutionKind.Rebuild, PgAlterCompatibilityRules.GetKindForTypeChange(from, to));
        }
        ...
        [DisplayName("PG GetKindForTypeChange：AutoIncrement 狀態變更應為 Rebuild")]
        ...
        [DisplayName("PG GetKindForTypeChange：Unknown 應為 NotSupported")]
        public void GetKindForTypeChange_UnknownType_ReturnsNotSupported(FieldDbType from, FieldDbType to)
        {
            Assert.Equal(ChangeExecutionKind.NotSupported, PgAlterCompatibilityRules.GetKindForTypeChange(from, to));
        }

        [Fact]
        [DisplayName("PG IsNarrowing：String 長度縮小應判定為 narrowing")]
        public void IsNarrowing_StringLengthReduced_ReturnsTrue()
        {
            ...
            Assert.True(PgAlterCompatibilityRules.IsNarrowing(oldField, newField));
        }

        [Fact]
        [DisplayName("PG IsNarrowing：String 長度放大不是 narrowing")]
        public void IsNarrowing_StringLengthIncreased_ReturnsFalse()
        {
            ...
            Assert.False(PgAlterCompatibilityRules.IsNarrowing(oldField, newField));
        }

        [Fact]
        [DisplayName("PG IsNarrowing：Text 轉 String（有長度上限）應判定為 narrowing")]
        ...
        [Fact]
        [DisplayName("PG IsNarrowing：String 轉 Text 不是 narrowing")]
        ...
        [DisplayName("PG IsNarrowing：數值型縮小應判定為 narrowing")]
        ...
        [InlineData(FieldDbType.Short, FieldDbType.Integer)]
        [InlineData(FieldDbType.Integer, FieldDbType.Long)]
        [DisplayName("PG IsNarrowing：數值型放大不是 narrowing")]
        ...
        [Fact]
        [DisplayName("PG IsNarrowing：Decimal precision 縮小應判定為 narrowing")]
        ...
        [Fact]
        [DisplayName("PG IsNarrowing：Decimal scale 縮小應判定為 narrowing")]
        ...
        [Fact]
        [DisplayName("PG IsNarrowing：DateTime 轉 Date 應判定為 narrowing（時間精度遺失）")]
        ...
        [Fact]
        [DisplayName("PG IsNarrowing：Date 轉 DateTime 不是 narrowing")]
