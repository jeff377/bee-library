...
namespace Bee.Db.UnitTests
{
    ...
    public class MySqlAlterCompatibilityRulesTests
    {
        ...
        [DisplayName("MySQL GetKindForTypeChange:同型別應為 Alter")]
        ...
        [Fact]
        [DisplayName("MySQL GetKindForTypeChange:AutoIncrement→AutoIncrement 同型別應為 Alter")]
        ...
        [DisplayName("MySQL GetKindForTypeChange:同 family 應為 Alter")]
        ...
        [DisplayName("MySQL GetKindForTypeChange:跨 family 應為 Rebuild")]
        ...
        [DisplayName("MySQL GetKindForTypeChange:AutoIncrement 狀態變更應為 Rebuild")]
        ...
        [DisplayName("MySQL GetKindForTypeChange:Unknown 應為 NotSupported")]
        ...
        [Fact]
        [DisplayName("MySQL IsNarrowing:String 長度縮小應判定為 narrowing")]
        ...
        [Fact]
        [DisplayName("MySQL IsNarrowing:String 長度放大不是 narrowing")]
        ...
        [Fact]
        [DisplayName("MySQL IsNarrowing:Text 轉 String(有長度上限)應判定為 narrowing")]
        ...
        [Fact]
        [DisplayName("MySQL IsNarrowing:String 轉 Text 不是 narrowing")]
        ...
        [DisplayName("MySQL IsNarrowing:數值型縮小應判定為 narrowing")]
        ...
        [InlineData(FieldDbType.Short, FieldDbType.Integer)]
        [InlineData(FieldDbType.Integer, FieldDbType.Long)]
        [DisplayName("MySQL IsNarrowing:數值型放大不是 narrowing")]
        ...
        [Fact]
        [DisplayName("MySQL IsNarrowing:Decimal precision 縮小應判定為 narrowing")]
        ...
        [Fact]
        [DisplayName("MySQL IsNarrowing:Decimal scale 縮小應判定為 narrowing")]
        ...
        [Fact]
        [DisplayName("MySQL IsNarrowing:DateTime 轉 Date 應判定為 narrowing(時間精度遺失)")]
        ...
        [Fact]
        [DisplayName("MySQL IsNarrowing:Date 轉 DateTime 不是 narrowing")]
        ...
        [Fact]
        [DisplayName("MySQL IsNarrowing:跨 family 不是 narrowing(由 GetKindForTypeChange 處理)")]
